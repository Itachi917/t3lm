      ...
      <div className="w-full max-w-md p-8 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black italic uppercase text-white tracking-tighter">
            Join the <span className="text-[#EDBB00]">Squad</span>
          </h1>
          <p className="text-slate-300 mt-2 font-medium">Create your student account</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl shadow-2xl">
          <form action={action} className="space-y-4">
            ...
            {/* Name Input */}
            <div>
              <label className="block text-xs font-bold uppercase text-[#EDBB00] mb-1 ml-1">Full Name</label>
              <input 
                name="name" 
                type="text" 
                required 
            ...
            {/* Email Input */}
            <div>
              <label className="block text-xs font-bold uppercase text-[#EDBB00] mb-1 ml-1">University Email</label>
              <input 
                name="email" 
                type="email" 
                required 
            ...
            {/* Error Message */}
            {state?.error && (
              <div className="bg-red-500/10 border border-red-500/50 rounded-lg p-3 text-red-200 text-sm font-medium text-center">
                {state.error}
              </div>
            )}
          ...
          <div className="mt-6 text-center border-t border-white/10 pt-6">
            <p className="text-slate-400 text-sm">
              ...
              <Link href="/login" className="text-[#EDBB00] hover:text-white font-bold uppercase transition-colors inline-flex items-center gap-1">
