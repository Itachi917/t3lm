...
export default async function Home() {
  ...
  const userName = session?.user?.name || "Culer";

  return (
    <div className="space-y-8">
      {/* Hero Banner - "Match Day" Style */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#004D98] to-[#A50044] p-8 md:p-12 text-white border-b-4 border-[#EDBB00]">
        <div className="relative z-10">
          <h1 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter mb-2">
            FORÇA <span className="text-[#EDBB00]">{userName}</span>!
          </h1>
          <p className="text-xl font-medium opacity-90 max-w-lg">
            Level 2 Midfielder • Ready for the next challenge?
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left: Latest News (Activity) */}
        <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between border-b-2 border-slate-200 pb-2">
                <h2 className="text-2xl font-black uppercase text-[#004D98]">Latest Updates</h2>
            ...
            <div className="group relative overflow-hidden rounded-lg bg-card border shadow-sm transition-all hover:shadow-lg">
                ...
                <div className="p-6 pt-10">
                    <h3 className="text-xl font-bold mb-2 group-hover:text-[#A50044] transition-colors">
                        New Python Course Released
                    </h3>
                    <p className="text-muted-foreground mb-4">
                        Dr. Sarah Connor has uploaded the new "Advanced AI" module. Check the locker room for details.
                    </p>
        ...
        {/* Right: Next Match (Deadline) */}
        <div className="space-y-6">
             <div className="bg-[#004D98] text-white rounded-xl p-6 relative overflow-hidden">
                <div className="relative z-10 text-center">
                    <h3 className="text-sm font-bold text-[#EDBB00] uppercase tracking-widest mb-2">Upcoming Deadline</h3>
                    <div className="text-5xl font-black mb-2">14:02</div>
                    <p className="font-medium mb-6">Until Python Assignment</p>
